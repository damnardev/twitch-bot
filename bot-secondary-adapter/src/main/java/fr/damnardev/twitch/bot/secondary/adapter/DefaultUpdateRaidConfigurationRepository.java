...
public class DefaultUpdateRaidConfigurationRepository implements UpdateRaidConfigurationRepository {
	...
	public void update(RaidConfiguration raidConfiguration) {
		log.info("Updating raid configuration {}", raidConfiguration.name());
		this.dbRaidConfigurationRepository.findByChannelName(raidConfiguration.name()).ifPresent((dbRaidConfiguration) -> {
		...
		log.info("Updated raid configuration {}", raidConfiguration.name());
	}
